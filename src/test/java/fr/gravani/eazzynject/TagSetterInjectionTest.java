...
public class TagSetterInjectionTest {
    Container container;
    ...
    static class DifferenceOfSquaresCalculator {
        ...
        @Inject
        @Tag("add")
        public void setAdd(Operator add) {
            this.add = add;
        }

        @Inject
        @Tag("subtract")
        public void setSubtract(Operator subtract) {
            this.subtract = subtract;
        }

        @Inject
        @Tag("multiply")
        public void setMultiply(Operator multiply) {
    ...
    static class MyCalculator {
        ...
        @Inject
        @Tag("average")
        public void setAverageOperator(Operator averageOperator) {
